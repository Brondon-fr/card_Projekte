...
import "./reportErrorButton.html";

/*
 * ############################################################################
 * filterItemReportCardsetButton
 * ############################################################################
 */

Template.filterItemReportCardsetButton.helpers({
	isProfileComplete: function () {
		return Profile.isCompleted();
	}
});

Template.filterItemReportCardsetButton.events({
	'click #reportErrorButton': function () {
